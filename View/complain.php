...
echo "<p class='user text'> $compMessage </p>";
...
<div class="complain_creation comment">
  ...
  <?php 
    if(!isset($_GET['updc'])){ ?>
        <form action="<?php echo $_SERVER['PHP_SELF']?>?cid=<?php echo $_GET['cid'] ?>" method="POST">
  ...
  <?php } ?>
    <div class="comment_wrapper">
        ...
        for ($i = $page; $i < ($entries+$page); $i++){
            ...
            <form action="<?php echo $_SERVER['PHP_SELF'].'?cid='.$_GET['cid'].'&pg='.$_GET['pg'];?>" method="POST">
